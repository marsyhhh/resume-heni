...
<head>
    ...
    <title>Resume | Add Experience</title>
</head>
...
<body>
    ...
    <div class="mx-36 px-10 pt-16 shadow-xl top-16 flex flex-col justify-center items-center">
        <div class="font-semibold text-3xl my-10">Add Experience</div>
        <form class="w-96 mb-10" action="{{url('/addExperience')}}" method="POST" enctype="multipart/form-data">
            @csrf
